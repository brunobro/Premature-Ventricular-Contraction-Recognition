...
SAVE_MACHINE = False
if OPT == 'S' or OPT == 's':
    SAVE_PROB    = str(input('Salvar Todas (S) ou Algumas (A)? '))
    SAVE_MACHINE = True
...
'''
features0_train = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TRAINING + '_' + config.DS_TRAINING + '_' + len_cycle_tra + '_0_desvio_QRS.txt'))
features1_train = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TRAINING + '_' + config.DS_TRAINING + '_' + len_cycle_tra + '_1_desvio_QRS.txt'))
...
'''
features0_test = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TEST + '_' + config.DS_TEST + '_' + len_cycle_tes + '_0_desvio_QRS.txt'))
features1_test = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TEST + '_' + config.DS_TEST + '_' + len_cycle_tes + '_1_desvio_QRS.txt'))
...
'''
if SAVE_MACHINE and SAVE_PROB == 'A':
...
if SAVE_MACHINE:
    ...
    if s0:
        joblib.dump(clf0, config.DIR_FILES_ALL_MACHINES + 'clf_I0.sav')   
    if s1:
        joblib.dump(clf1, config.DIR_FILES_ALL_MACHINES + 'clf_I1.sav')    
