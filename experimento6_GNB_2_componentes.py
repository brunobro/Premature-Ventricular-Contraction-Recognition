...
Foram consideradas a classe CPV e Normal + outros aritmias
"""
...
'''
features0_train = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TRAINING + '_' + config.DS_TRAINING  + '_' + len_cycle_tra + '_0_todas_arritmias.txt'))
features1_train = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TRAINING + '_' + config.DS_TRAINING  + '_' + len_cycle_tra + '_1_todas_arritmias.txt'))
targets_train   = np.loadtxt(config.DIR_FILES + config.FILE_TARGET_TRAINING + '_' + config.DS_TRAINING  + '_' + len_cycle_tra + '_todas_arritmias.txt')
...
'''
features0_test = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TEST + '_' + config.DS_TEST  + '_' + len_cycle_tra + '_0_todas_arritmias.txt'))
features1_test = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TEST + '_' + config.DS_TEST  + '_' + len_cycle_tra + '_1_todas_arritmias.txt'))
targets_test   = np.loadtxt(config.DIR_FILES + config.FILE_TARGET_TEST + '_' + config.DS_TEST  + '_' + len_cycle_tra + '_todas_arritmias.txt')
