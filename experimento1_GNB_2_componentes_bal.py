# -*- coding: utf-8 -*-
"""
Neste experimento são utilizadas a base DS1 para treinamento e DS2 BALANCEADAS para teste e duas componentes ocultas da abordagem proposta. 
...
'''
features0_train = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TRAINING + '_' + config.DS_TRAINING + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_0.txt'))
features1_train = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TRAINING + '_' + config.DS_TRAINING + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_1.txt'))
targets_train   = np.loadtxt(config.DIR_FILES + config.FILE_TARGET_TRAINING + '_' + config.DS_TRAINING + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '.txt')
...
'''
features0_test = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TEST + '_' + config.DS_TEST + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_0.txt'))
features1_test = tools.rectify(np.loadtxt(config.DIR_FILES + '2componentes/' + config.FILE_FEATURES_TEST + '_' + config.DS_TEST + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_1.txt'))
targets_test   = np.loadtxt(config.DIR_FILES + config.FILE_TARGET_TEST + '_' + config.DS_TEST + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '.txt')
...
'''
print('######################## EXP5 #####################')
print('Voto AHP - padrão negativo')
