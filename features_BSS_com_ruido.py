...
def snr_calc(s, n):
    Ps = (np.sum(np.abs(s))**2)/len(s)
    Pn = (np.sum(np.abs(n))**2)/len(s)
...
def __getFeatures(data_cycle, N_COMPONENTS, N_SUB, DATABASE):
    ...
    for cycle in data_cycle:
        ...
        noise = np.random.random(len(cycle))
        SNR.append(snr_calc(cycle, noise))
        cycle += noise
...
def run(DS_TRAINING, DS_TEST, N_COMPONENTS, N_SUB, DATABASE_TRAINING, DATABASE_TEST):
    ...
    '''
    if N_COMPONENTS >= 2:
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + len_cycle_tra + '_noise_0.txt', features_TRAINING0, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + len_cycle_tra + '_noise_1.txt', features_TRAINING1, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_noise_0.txt', features_TRAINING0_BAL, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_noise_1.txt', features_TRAINING1_BAL, delimiter=' ', fmt='%1.4f')
        del features_TRAINING0, features_TRAINING0_BAL
        del features_TRAINING1, features_TRAINING1_BAL
            
    if N_COMPONENTS >= 3:
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + len_cycle_tra + '_noise_2.txt', features_TRAINING2, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_noise_2.txt', features_TRAINING2_BAL, delimiter=' ', fmt='%1.4f')
        del features_TRAINING2, features_TRAINING2_BAL
        
    if N_COMPONENTS >= 4:
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + len_cycle_tra + '_noise_3.txt', features_TRAINING3, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TRAINING + '_' + LABEL_RECORDS_TRA + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tra + '_noise_3.txt', features_TRAINING3_BAL, delimiter=' ', fmt='%1.4f')
    ...
    '''
    if N_COMPONENTS >= 2:
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + len_cycle_tes + '_noise_0.txt', features_TEST0, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + len_cycle_tes + '_noise_1.txt', features_TEST1, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tes + '_noise_0.txt', features_TEST0_BAL, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tes + '_noise_1.txt', features_TEST1_BAL, delimiter=' ', fmt='%1.4f')
        del features_TEST0, features_TEST0_BAL
        del features_TEST1, features_TEST1_BAL
    
    if N_COMPONENTS >= 3:
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + len_cycle_tes + '_noise_2.txt', features_TEST2, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tes + '_noise_2.txt', features_TEST2_BAL, delimiter=' ', fmt='%1.4f')
        del features_TEST2, features_TEST2_BAL
        
    if N_COMPONENTS >= 4:
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + len_cycle_tes + '_noise_3.txt', features_TEST3, delimiter=' ', fmt='%1.4f')
        np.savetxt(config.DIR_FILES + config.FILE_FEATURES_TEST + '_' + LABEL_RECORDS_TES + '_' + config.FILE_SAMPLES_BALANCED + '_' + len_cycle_tes + '_noise_3.txt', features_TEST3_BAL, delimiter=' ', fmt='%1.4f')
